...
function findCourseIdByName(courseName) {
	try {
		...
		for (const a of anchors) {
			...
			const text =
				normalize(a.textContent) || normalize(a.getAttribute("title")) || normalize(a.getAttribute("aria-label"));
		...
		for (const el of courseEls) {
			...
			const text =
				normalize(el.textContent) || normalize(el.getAttribute("title")) || normalize(el.getAttribute("aria-label"));
